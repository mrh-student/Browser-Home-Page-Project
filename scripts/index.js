...
const timeZoneList = [
  {
    listingName: "America/Detroit",
    listingClassName: 'js-ny',
    office: "New York",
    listingId: "newyork"
  },
  {
    listingName: "Australia/Melbourne",
    listingClassName: 'js-mb',
    office: "Melbourne",
    listingId: "melbourne"
  },
  {
    listingName: "Europe/Berlin",
    listingClassName: 'js-bl',
    office: "Berlin",
    listingId: "berlin"
  },
  {
    listingName: "Europe/London",
    listingClassName: 'js-ld',
    office: "London",
    listingId: "london"
  },
  {
    listingName: "America/Sao_Paulo",
    listingClassName: 'js-md',
    office: "Mendoza",
    listingId: "mendoza"
  },
  {
    listingName: "America/Chicago",
    listingClassName: 'js-nv',
    office: "Nashville",
    listingId: "nashville"
  },
  {
    listingName: "America/Los_Angeles",
    listingClassName: 'js-sf',
...
function getTimeZones(timeZoneList, now) {
  ...
  for (i = 0; i < timeZoneList.length ; i++){
    var listingClassName = timeZoneList[i].listingClassName
    var listingName = timeZoneList[i].listingName
    var listing_jstime = moment.tz(now, listingName)
    var listing_location = timeZoneList[i].office
    var listing_html = timeZoneList[i].listingId
    var listing = {
      jsclass: listingClassName,
      jstime: listing_jstime,
      jslocation: listing_location,
      jshtmlid: listing_html
    }
    times.push(listing)
  }
  return times; 
